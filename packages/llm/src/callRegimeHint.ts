...
function parseHintResponse(text: string): { label: RegimeHintLabel; rationale: string; confidence: number } {
  const valid: RegimeHintLabel[] = ['HIGH_SCORING', 'LOW_SCORING', 'VOLATILE', 'DEFENSIVE', 'STANDARD'];
  try {
