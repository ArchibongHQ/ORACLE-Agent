...
export interface RunState {
  telemetry?: {
    ...
    xH?: number; xA?: number;
    restH?: number; restA?: number;
    travelKm?: number; altitudeM?: number;
    hoursToKO?: number;
    hOdds?: number; dOdds?: number; aOdds?: number;
    ohO?: number; oaO?: number;
    broll?: number; peakBroll?: number;
    injPenH?: number; injPenA?: number;
    ...
    oppGA_H?: number; oppGA_A?: number;
    softContext?: SoftContextItem[];
    [key: string]: unknown;
  };
  pipeline?: {
    fixture?: { home?: string; away?: string; league?: string; date?: string; [key: string]: unknown };
